# CLAIM CARD — tormiq_alpine_cleft  (v260, seed 42, 200 steps)
...
**Deterministic (5):** epidote, actinolite, quartz, feldspar, albite
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
**Surprises (present but absent from all authored expectation tiers):** titanite
