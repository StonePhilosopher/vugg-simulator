# CLAIM CARD — sulphur_bank  (v243, seed 42, 200 steps)
...
| 4 | orpiment | 0 | 6 |
| 5 | realgar | 0 | 6 |
| 6 | native_sulfur | 27 | 4 |
| 7 | pyrite | 31 | 1 |
| 8 | opal | 92 | 9 |

**Surprises (grown but NOT in expects_species):** metacinnabar, opal
...
## Saturation drivers
  ...
  - SI_selenite: -0.504 → -0.378  [-0.504, -0.378]
  - SI_anhydrite: -0.567 → -0.504  [-0.693, -0.378]
  - SI_barite: -8 → -8  [-8, -8]
