# CLAIM CARD — porphyry  (v243, seed 42, 120 steps)
...
## Paragenetic order as grown (19 species)
...
**Surprises (grown but NOT in expects_species):** albite, argentite, bismuthinite, feldspar, native_gold, arsenopyrite, titanite, stibnite, galena, tennantite, tetrahedrite, magnetite, epidote, quartz, anhydrite, malachite
**No-shows (expected but never nucleated):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 398.622 → 310.039 °C  [236.22, 398.622]
  - pH: 5.016 → 6.665   [5.016, 6.667]
...
## Saturation drivers
  - SI_calcite: -6.236 → -3.026  [-6.236, -2.835]
  - SI_aragonite: -6.299 → -3.097  [-6.299, -2.9]
  - SI_dolomite: -8 → -5.231  [-8, -4.916]
  - SI_HMC: -7.874 → -4.664  [-7.874, -4.475]
  - SI_siderite: -3.528 → 0.249  [-3.528, 0.315]
  - SI_selenite: -1.323 → -0.819  [-1.323, -0.819]
