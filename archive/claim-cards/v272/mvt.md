# CLAIM CARD — mvt  (v272, seed 42, 120 steps)
...
**Scenario spec hash:** a50597c461a444574da2c4bb1160b162920e18f1500c0ff02cacf403482f3b39
**Archived strip SHA-256:** d5bb3bdfedd45a8eb56cce8abb561385f0fc6ece9d345cf6f5c946be5256499e
...
| 3 | galena | 20 | 4 | 0 | nucleation |
| 4 | sphalerite | 20 | 1 | 0 | nucleation |
| 5 | barite | 21 | 6 | 0 | nucleation |
| 6 | anhydrite | 22 | 6 | 0 | nucleation |
| 7 | greenockite | 22 | 5 | 0 | nucleation |
| 8 | pyrite | 27 | 2 | 0 | nucleation |
| 9 | quartz | 28 | 1 | 0 | nucleation |
...
## Saturation drivers
  - SI_calcite: 0.126 → 0.126  [-0.189, 0.756]
  - SI_aragonite: 0 → 0.063  [-0.252, 0.693]
  - SI_dolomite: 0.252 → 0  [-0.441, 0.756]
  - SI_HMC: 0.441 → 0.441  [0.126, 0.945]
  - SI_siderite: 1.575 → 2.016  [1.575, 2.142]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -8 → 0  [-8, 0.756]
  - SI_barite: -8 → 1.512  [-8, 2.142]
  - SI_celestine: -8 → 0.378  [-8, 1.701]
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 1266; formula-bearing=0; solid-solution=0; binding competition=0; reactive transformation etches=0.
  ...
  - Habit crystal 4: galena; cubic; extent=individual; forms=["{100} cube","{111} octahedron"]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  ...
  - Habit crystal 8: greenockite; powdery_coating; extent=individual; forms=["bright yellow earthy dust on sphalerite"]; size authority={"extent_kind":"individual","cap_cm":3,"record_cm":1.5}; CDR=null.
  ...
  - Habit crystal 10: greenockite; colloform_crust; extent=individual; forms=["encrusting colloform aggregate"]; size authority={"extent_kind":"individual","cap_cm":3,"record_cm":1.5}; CDR=null.
  - Habit crystal 11: barite; snowball; extent=individual; forms=[]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  - Habit crystal 12: barite; snowball; extent=individual; forms=[]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  - Habit crystal 13: pyrite; cubo-pyritohedral; extent=individual; forms=["{100} + {210}"]; size authority={"extent_kind":"individual","cap_cm":40,"record_cm":20}; CDR=null.
  ...
  - Habit crystal 15: barite; snowball; extent=individual; forms=[]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  - Habit crystal 16: greenockite; powdery_coating; extent=individual; forms=["bright yellow earthy dust on sphalerite"]; size authority={"extent_kind":"individual","cap_cm":3,"record_cm":1.5}; CDR=null.
  - Habit crystal 17: pyrite; striated_cubo_pyritohedral; extent=individual; forms=["{100} + {210}, striated"]; size authority={"extent_kind":"individual","cap_cm":40,"record_cm":20}; CDR=null.
  ...
  - Habit crystal 19: greenockite; colloform_crust; extent=individual; forms=["encrusting colloform aggregate"]; size authority={"extent_kind":"individual","cap_cm":3,"record_cm":1.5}; CDR=null.
  - Habit crystal 20: galena; cubic; extent=individual; forms=["{100} cube","{111} octahedron"]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  - Habit crystal 21: galena; cubic; extent=individual; forms=["{100} cube","{111} octahedron"]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  - Habit crystal 22: anhydrite; tabular; extent=individual; forms=["tabular crystals","three perpendicular cleavages"]; size authority={"extent_kind":"individual","cap_cm":200,"record_cm":100}; CDR=null.
  ...
  - Habit crystal 24: galena; cubic; extent=individual; forms=["{100} cube","{111} octahedron"]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
