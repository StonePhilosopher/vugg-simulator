# CLAIM CARD — searles_lake  (v263, seed 42, 300 steps)
...
**Archived strip SHA-256:** a9dcd7ff3fd8fec45f3b9b0add65c3af35aaaa6f45e180c052d3d292830c9eb6
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 120: borax → tincalconite (temperature)
  - Transformation step 120: borax → tincalconite (temperature)
  - Transformation step 122: mirabilite → thenardite (temperature)
  - Transformation step 180: mirabilite → thenardite (temperature)
  - Transformation step 181: borax → tincalconite (temperature)
  - Transformation step 181: mirabilite → thenardite (temperature)
