# CLAIM CARD — supergene_oxidation  (v263, seed 42, 200 steps)
...
**Archived strip SHA-256:** 22cf16dba299d9e60606385f9b4bc8968a7c1c6419d0ec8230cab28d95d8a803
...
## Environment trajectory (first → last, [min,max])
  - T: 33.26089435471212 → 24.999999999999957 °C  [24.999999999999837, 48.60449873260213] (raw_simulation_state)
  - pH: 6.8 → 4.485610805768792   [4.252075387667224, 6.873928397942787] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -0.945 → -4.157  [-4.661, -0.315]
  - SI_aragonite: -1.071 → -4.346  [-4.787, -0.441]
  - SI_dolomite: -2.835 → -8  [-8, -0.819]
  - SI_HMC: -1.008 → -4.22  [-4.724, -0.315]
  - SI_siderite: 0.945 → -2.9  [-3.402, 1.323]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 33.26089435471212 → 24.999999999999957 °C [24.999999999999837, 48.60449873260213], n=200
