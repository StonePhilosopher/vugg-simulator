# CLAIM CARD — zoned_dripstone_cave  (v257, seed 42, 150 steps)
...
**Scenario spec hash:** 294a1573eb12b5e64a2d87cc0ec0c57db932883a141ac850634269feedbe953d
...
**Surprises (present but absent from all authored expectation tiers):** dolomite
...
## Saturation drivers
  ...
  - SI_dolomite: 5.417 → 5.417  [5.417, 5.417]
  - SI_HMC: 2.583 → 2.583  [2.583, 2.583]
  - SI_siderite: 1.512 → 1.512  [1.512, 1.512]
  - SI_selenite: -1.701 → -1.701  [-1.701, -1.701]
  - SI_anhydrite: -1.953 → -1.953  [-1.953, -1.953]
  - SI_barite: 0.441 → 0.441  [0.441, 0.441]
  - SI_celestine: -3.15 → -3.15  [-3.15, -3.15]
...
> Scenario chemistry — global broth (= equator): Ca=2000, Mg=1500, CO3=2200, pH=8.4. The aqueous molar Mg/Ca is 1.24, just above the evidence threshold, so both carbonate engines can enter their local competition. Zone overrides then split the cavity:
