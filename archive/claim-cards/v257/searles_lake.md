# CLAIM CARD — searles_lake  (v257, seed 42, 300 steps)
...
| 4 | halite | 32 | 33 | 0 | nucleation |
| 5 | borax | 36 | 7 | 0 | nucleation |
| 6 | thenardite | 60 | 5 | 10 | nucleation; mirabilite -> thenardite |
...
## Saturation drivers
  ...
  - SI_dolomite: 1.575 → 1.26  [1.26, 2.583]
  - SI_HMC: 0.567 → 0.378  [0.378, 1.071]
  - SI_siderite: 1.323 → 1.134  [1.134, 1.953]
  - SI_selenite: -1.638 → -1.575  [-2.079, -1.575]
  - SI_anhydrite: -1.764 → -1.764  [-2.205, -1.638]
  - SI_barite: -8 → -8  [-8, -8]
  - SI_celestine: -0.567 → -0.504  [-0.945, -0.441]
