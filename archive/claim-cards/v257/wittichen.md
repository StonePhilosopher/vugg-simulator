# CLAIM CARD — wittichen  (v257, seed 42, 160 steps)
...
**Deterministic (10):** skutterudite, nickeline, safflorite, native_bismuth, native_arsenic, native_silver, proustite, acanthite, calcite, barite
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
| 10 | barite | 141 | 3 | 0 | nucleation |
| 11 | calcite | 142 | 1 | 0 | nucleation |

**Surprises (present but absent from all authored expectation tiers):** realgar
...
## Environment trajectory (first → last, [min,max])
  - T: 339.9778271484375 → 148.2830672062741 °C  [148.2830672062741, 339.9778271484375] (raw_simulation_state)
  - pH: 6.3 → 7.4   [6.3, 7.4] (raw_simulation_state)
  - Eh: -19.98891357421875 → 74.98891357421832 mV  [-280.92380224446623, 74.98891357421832] (raw_simulation_state)
  - salinity: 24 → 24 psu  [24, 24] (raw_simulation_state)
  - O2: 0.16597563761020587 → 0.3980665220032071 mg/L  [0.0024590195274729384, 0.3980665220032071] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: -3.339 → 0.756  [-3.339, 0.756]
  - SI_aragonite: -3.402 → 0.63  [-3.402, 0.63]
  - SI_dolomite: -6.551 → -0.882  [-7.622, -0.882]
  - SI_HMC: -3.213 → 0.693  [-3.213, 0.693]
  - SI_siderite: -1.575 → 1.008  [-1.575, 1.008]
  - SI_selenite: -5.669 → -1.134  [-8, -1.134]
  - SI_anhydrite: -5.291 → -1.575  [-8, -1.575]
  - SI_barite: -3.78 → 1.071  [-8, 1.071]
  - SI_celestine: -5.417 → -1.827  [-8, -1.764]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 339.9778271484375 → 148.2830672062741 °C [148.2830672062741, 339.9778271484375], n=160
  - Secure aragonite assessment: 0/160 executed steps; first={"boundary_kbar":3.0413872177406542,"secure_aragonite":false}, last={"boundary_kbar":2.4422526325923375,"secure_aragonite":false}
