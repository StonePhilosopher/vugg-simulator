# CLAIM CARD — mvt  (v238, seed 42, 120 steps)
...
**Scenario spec hash:** d236c0698bb8a1c15f629361bdac41eb766e1c5b809e09c7c6bb5b7a77bc3b33
...
**Surprises (grown but NOT in expects_species):** rhodochrosite, siderite, pyrite, anhydrite, greenockite, celestine, quartz, hawleyite, aragonite
...
## Saturation drivers
  - SI_calcite: 0.378 → 0.063  [-1.197, 1.071]
  - SI_aragonite: 0.315 → -0.063  [-1.26, 0.945]
  - SI_dolomite: 0.819 → -0.315  [-2.457, 1.323]
  - SI_HMC: -1.323 → -1.638  [-2.898, -0.63]
  - SI_siderite: 1.89 → 2.142  [1.134, 2.457]
  - SI_selenite: -8 → -1.26  [-8, -0.567]
  - SI_anhydrite: -8 → -1.134  [-8, -0.441]
  - SI_barite: -8 → 1.008  [-8, 2.016]
  - SI_celestine: -8 → -0.756  [-8, -0.063]
