# CLAIM CARD — zoned_dripstone_cave  (v238, seed 42, 150 steps)
...
**expects_species (2):** calcite, aragonite
...
**Surprises (grown but NOT in expects_species):** dolomite, HMC
...
## Saturation drivers
  ...
  - SI_selenite: -1.575 → -1.575  [-1.575, -1.575]
  - SI_anhydrite: -1.827 → -1.827  [-1.827, -1.827]
  - SI_barite: 0.441 → 0.441  [0.441, 0.441]
  - SI_celestine: -1.827 → -1.827  [-1.827, -1.827]
