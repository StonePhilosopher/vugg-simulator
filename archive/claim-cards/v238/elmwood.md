# CLAIM CARD — elmwood  (v238, seed 42, 200 steps)
...
**Surprises (grown but NOT in expects_species):** galena, pyrite, siderite, aragonite, celestine, quartz, selenite
...
## Saturation drivers
  - SI_calcite: 0.693 → 2.079  [0.693, 2.646]
  - SI_aragonite: 0.567 → 1.953  [0.567, 2.52]
  - SI_dolomite: 0.945 → 3.654  [0.819, 4.535]
  - SI_HMC: -1.008 → 0.819  [-1.008, 1.071]
  - SI_siderite: 1.512 → 2.331  [1.512, 3.402]
  - SI_selenite: -8 → -0.756  [-8, -0.504]
  - SI_anhydrite: -8 → -0.882  [-8, -0.441]
  - SI_barite: -8 → 2.457  [-8, 2.457]
  - SI_celestine: -8 → -0.189  [-8, 0.126]
