# CLAIM CARD — bisbee  (v238, seed 42, 340 steps)
...
| 21 | atacamite | 83 | 4 |
| 22 | brochantite | 83 | 5 |
| 23 | native_copper | 125 | 1 |
| 24 | turquoise | 149 | 4 |
| 25 | erythrite | 165 | 4 |
| 26 | azurite | 179 | 4 |
| 27 | opal | 179 | 5 |
| 28 | annabergite | 188 | 3 |
| 29 | mimetite | 232 | 2 |
| 30 | dioptase | 264 | 4 |
| 31 | halite | 320 | 3 |

**Surprises (grown but NOT in expects_species):** albite, argentite, feldspar, pyrite, tennantite, tetrahedrite, bornite, native_gold, arsenopyrite, native_silver, acanthite, chalcocite, covellite, marcasite, selenite, cuprite, goethite, atacamite, native_copper, turquoise, erythrite, opal, annabergite, mimetite, dioptase, halite
**No-shows (expected but never nucleated):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 398.622 → 23.622 °C  [23.622, 398.622]
  - pH: 5.291 → 6.49   [4.795, 7.381]
...
## Saturation drivers
  - SI_calcite: -6.11 → -2.346  [-6.11, -0.194]
  - SI_aragonite: -6.173 → -2.483  [-6.173, -0.32]
  - SI_dolomite: -8 → -4.64  [-8, -0.268]
  - SI_HMC: -7.748 → -3.354  [-7.748, -1.202]
  - SI_siderite: -2.583 → -0.567  [-2.583, 1.635]
  - SI_selenite: -1.449 → -3.181  [-8, -1.197]
  - SI_anhydrite: -1.008 → -3.307  [-8, -1.008]
  - SI_barite: -8 → -8  [-8, -8]
