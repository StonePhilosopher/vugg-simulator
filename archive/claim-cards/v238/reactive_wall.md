# CLAIM CARD — reactive_wall  (v238, seed 42, 120 steps)
...
| 10 | pyrite | 41 | 1 |
| 11 | siderite | 41 | 1 |
| 12 | rhodochrosite | 42 | 1 |
| 13 | dolomite | 89 | 1 |

**Surprises (grown but NOT in expects_species):** calcite, acanthite, celestine, quartz, galena, marcasite, selenite, siderite, rhodochrosite
...
## Saturation drivers
  - SI_calcite: 0.315 → 0.441  [-4.346, 0.819]
  - SI_aragonite: 0.189 → 0.315  [-4.409, 0.693]
  - SI_dolomite: 0.693 → 0.315  [-8, 1.197]
  - SI_HMC: -1.323 → -1.26  [-5.858, -0.882]
  - SI_siderite: 1.449 → 1.953  [-2.835, 2.394]
  - SI_selenite: -0.945 → -0.693  [-0.945, -0.567]
  - SI_anhydrite: -0.882 → -0.63  [-0.882, -0.499]
  - SI_barite: 1.575 → 2.205  [1.575, 2.52]
  - SI_celestine: -0.378 → -0.252  [-0.441, -0.126]
