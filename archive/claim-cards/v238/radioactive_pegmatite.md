# CLAIM CARD — radioactive_pegmatite  (v238, seed 42, 120 steps)
...
## Saturation drivers
  - SI_calcite: -3.906 → -2.52  [-3.906, -1.698]
  - SI_aragonite: -4.029 → -2.646  [-4.029, -1.764]
  - SI_dolomite: -7.622 → -5.669  [-7.622, -4.402]
  - SI_HMC: -5.606 → -3.591  [-5.606, -3.402]
  - SI_siderite: -0.693 → -0.126  [-0.693, 0.693]
  - SI_selenite: -1.701 → -1.764  [-1.764, -1.701]
  - SI_anhydrite: -1.134 → -1.979  [-1.979, -1.134]
  - SI_barite: -8 → -8  [-8, -8]
