# CLAIM CARD — schneeberg  (v238, seed 42, 160 steps)
...
**Surprises (grown but NOT in expects_species):** argentite, feldspar, morganite, quartz, spodumene, arsenopyrite, topaz, bismuthinite, proustite, tennantite, naumannite, native_silver, acanthite, chrysocolla, opal, brochantite, cuprite, dioptase, turquoise, selenite, uranophane, goethite
**No-shows (expected but never nucleated):** pharmacolite, haidingerite
...
## Saturation drivers
  - SI_calcite: -3.906 → -2.142  [-3.906, -2.142]
  - SI_aragonite: -4.031 → -2.27  [-4.031, -2.27]
  - SI_dolomite: -7.433 → -5.039  [-7.433, -4.724]
  - SI_HMC: -5.606 → -3.213  [-5.606, -3.213]
  - SI_siderite: -0.882 → -0.262  [-0.882, 0.378]
