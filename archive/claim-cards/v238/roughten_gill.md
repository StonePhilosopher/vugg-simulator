# CLAIM CARD — roughten_gill  (v238, seed 42, 200 steps)
...
| 23 | cerussite | 144 | 4 |
| 24 | rosasite | 158 | 3 |
| 25 | aurichalcite | 174 | 2 |
| 26 | leadhillite | 174 | 2 |
| 27 | descloizite | 175 | 4 |

**Surprises (grown but NOT in expects_species):** chalcocite, orpiment, proustite, realgar, acanthite, chrysocolla, covellite, plumbogummite, selenite, vanadinite, turquoise, rosasite, aurichalcite, descloizite
...
## Saturation drivers
  ...
  - SI_HMC: -6.047 → -1.945  [-6.047, -1.945]
  - SI_siderite: -2.205 → -6.609  [-8, 0.441]
  - SI_selenite: -1.008 → -1.336  [-1.638, -1.008]
  - SI_anhydrite: -0.882 → -1.575  [-1.827, -0.882]
  - SI_barite: -8 → -8  [-8, -8]
