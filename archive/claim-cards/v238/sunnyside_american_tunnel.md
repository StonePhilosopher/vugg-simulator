# CLAIM CARD — sunnyside_american_tunnel  (v238, seed 42, 200 steps)
...
| 11 | fluorite | 109 | 1 |
| 12 | pyrite | 111 | 1 |
| 13 | arsenopyrite | 117 | 4 |
| 14 | titanite | 171 | 1 |

**Surprises (grown but NOT in expects_species):** argentite, tennantite, tetrahedrite, proustite, albite, siderite, arsenopyrite, titanite
...
## Saturation drivers
  - SI_calcite: -6.74 → -2.205  [-6.74, -0.441]
  - SI_aragonite: -6.866 → -2.331  [-6.866, -0.567]
  - SI_dolomite: -8 → -4.724  [-8, -1.89]
  - SI_HMC: -8 → -3.969  [-8, -2.205]
  - SI_siderite: -4.913 → 0.126  [-4.913, 1.26]
  - SI_selenite: -0.504 → -0.756  [-0.759, -0.504]
  - SI_anhydrite: -0.189 → -0.504  [-0.63, -0.189]
  - SI_barite: -8 → -8  [-8, -8]
