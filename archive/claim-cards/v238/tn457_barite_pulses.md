# CLAIM CARD — tn457_barite_pulses  (v238, seed 42, 110 steps)
...
**Surprises (grown but NOT in expects_species):** quartz
...
## Saturation drivers
  - SI_calcite: -2.016 → -1.764  [-2.709, -1.575]
  - SI_aragonite: -2.142 → -1.89  [-2.835, -1.701]
  - SI_dolomite: -4.22 → -3.906  [-5.669, -3.591]
  - SI_HMC: -3.654 → -3.465  [-4.346, -3.213]
  - SI_siderite: -0.441 → 0.504  [-8, 0.567]
  - SI_selenite: -1.26 → -1.575  [-1.575, -1.26]
  - SI_anhydrite: -1.197 → -1.512  [-1.638, -1.197]
  - SI_barite: 1.197 → 2.961  [1.197, 3.402]
