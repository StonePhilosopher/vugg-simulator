# CLAIM CARD — reactivated_fluorite_vein  (v238, seed 42, 160 steps)
...
**expects_species (5):** fluorite, galena, barite, calcite, sphalerite
...
**Surprises (grown but NOT in expects_species):** rhodochrosite, siderite, acanthite, pyrite, greenockite, celestine, quartz
...
## Saturation drivers
  ...
  - SI_aragonite: 0.315 → 0.315  [0.063, 0.756]
  - SI_dolomite: 0.504 → -0.189  [-0.441, 0.945]
  - SI_HMC: -1.323 → -1.134  [-1.575, -0.882]
  - SI_siderite: 1.89 → 2.079  [1.89, 2.394]
  - SI_selenite: -8 → -0.693  [-8, -0.567]
  - SI_anhydrite: -8 → -0.756  [-8, -0.378]
  - SI_barite: -8 → 2.142  [-8, 2.142]
  - SI_celestine: -8 → -0.315  [-8, -0.063]
