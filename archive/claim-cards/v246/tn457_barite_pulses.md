# CLAIM CARD — tn457_barite_pulses  (v246, seed 42, 110 steps)
...
## Environment trajectory (first → last, [min,max])
  - T: 118.11 → 59.055 °C  [59.055, 118.11]
  - pH: 6.504 → 6.504   [6.504, 6.669]
...
## Saturation drivers
  - SI_calcite: -2.016 → -2.268  [-2.268, -1.701]
  - SI_aragonite: -2.142 → -2.391  [-2.391, -1.764]
  - SI_dolomite: -4.22 → -4.598  [-4.598, -3.717]
  - SI_HMC: -3.654 → -3.528  [-3.654, -3.276]
  - SI_siderite: -0.252 → -0.567  [-0.567, -0.063]
  - SI_selenite: -1.638 → -1.512  [-1.638, -1.512]
  - SI_anhydrite: -1.575 → -1.638  [-1.638, -1.575]
  - SI_barite: 0.819 → 3.528  [0.819, 3.528]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 118.26089435471222 → 58.09273303374648 °C [58.09273303374648, 118.26089435471222], n=110
  - Secure aragonite assessment: 0/110 executed steps; first={"boundary_kbar":2.5081736661946623,"secure_aragonite":false}, last={"boundary_kbar":2.7705256787395465,"secure_aragonite":false}
