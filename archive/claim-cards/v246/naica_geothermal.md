# CLAIM CARD — naica_geothermal  (v246, seed 42, 320 steps)
...
**Surprises (grown but NOT in expects_species):** celestine, chalcedony, thenardite
...
## Saturation drivers
  - SI_calcite: -0.504 → -0.819  [-0.819, -0.504]
  - SI_aragonite: -0.63 → -1.008  [-1.008, -0.63]
  - SI_dolomite: -1.953 → -2.646  [-2.646, -1.953]
  - SI_HMC: -1.827 → -1.953  [-1.953, -1.827]
  - SI_siderite: -0.441 → -0.882  [-0.882, -0.441]
  - SI_selenite: 0.063 → -0.063  [-0.315, 0.063]
  - SI_anhydrite: -0.063 → -0.252  [-0.504, -0.063]
  - SI_barite: -8 → -8  [-8, -8]
  - SI_celestine: -0.126 → -0.315  [-0.57, -0.126]
