# CLAIM CARD — amethyst_geode  (v246, seed 42, 240 steps)
...
**expects_species (2):** chalcedony, quartz
...
## Saturation drivers
  - SI_calcite: -1.134 → -0.945  [-1.134, -0.693]
  - SI_aragonite: -1.197 → -1.071  [-1.197, -0.819]
  - SI_dolomite: -2.016 → -2.079  [-2.079, -1.764]
  - SI_HMC: -2.772 → -2.331  [-2.772, -2.331]
  - SI_siderite: 1.638 → 1.575  [1.575, 1.827]
  - SI_selenite: -8 → -8  [-8, -8]
