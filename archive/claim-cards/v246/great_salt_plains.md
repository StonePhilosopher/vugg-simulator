# CLAIM CARD — great_salt_plains  (v246, seed 42, 250 steps)
...
**Scenario spec hash:** d2e1abd9b34125d9a80826c2389949f26f336410f10248bbbb3b4ddaae93f173
...
**Surprises (grown but NOT in expects_species):** calcite, mirabilite, thenardite
...
## Environment trajectory (first → last, [min,max])
  ...
  - salinity: 200 → 200 psu  [34.646, 200]
  - O2: 1.614 → 1.575 mg/L  [1.22, 1.772]
  - concentration: 0.984 → 2.992 ×  [0.984, 2.992]

## Saturation drivers
  - SI_calcite: 0.693 → 0.693  [-0.945, 0.882]
  - SI_aragonite: 0.567 → 0.567  [-1.071, 0.756]
  - SI_dolomite: 1.638 → 1.575  [-2.016, 1.89]
  - SI_HMC: -0.315 → -0.315  [-1.953, -0.189]
  - SI_siderite: 0.693 → 0.693  [-1.008, 0.819]
  - SI_selenite: 1.701 → 2.079  [-0.567, 2.079]
  - SI_anhydrite: 1.638 → 2.016  [-0.756, 2.016]
  - SI_barite: -8 → -8  [-8, -8]
  - SI_celestine: 1.008 → 1.323  [-0.819, 1.323]
