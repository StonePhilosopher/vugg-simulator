# CLAIM CARD — elmwood  (v246, seed 42, 200 steps)
...
**Surprises (grown but NOT in expects_species):** galena, pyrite, siderite, aragonite, celestine, chalcedony
...
## Saturation drivers
  ...
  - SI_anhydrite: -8 → -1.008  [-8, -0.756]
  - SI_barite: -8 → 2.331  [-8, 2.331]
  - SI_celestine: -8 → -0.315  [-8, -0.126]
