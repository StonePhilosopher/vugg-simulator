# CLAIM CARD — ouro_preto  (v268, seed 42, 260 steps)
...
**Scenario spec hash:** 5bae6f9bbcc7e203a6ea8d56c69376752be9afa6bcfb7fe0ecf644c0520fda15
**Archived strip SHA-256:** 8633e56633d3e006928e8ed99c206492348927db7e7ba8b8234849b732819aba
...
**Deterministic accessories (4):** albite — A plausible product of sodic phyllite/feldspar alteration in the Ouro Preto metamorphic-hydrothermal vein.; feldspar — A subordinate wall-rock alteration/gangue phase derived from the feldspathic component of the host sequence.; goethite — A plausible late oxidizing Fe-weathering product after the imperial-topaz vein cools.; opal — Hydrated silica is a plausible late low-temperature competitor after the main topaz-quartz stage.
**Statistical (2):** lepidocrocite — A minor late Fe-oxyhydroxide permitted during terminal oxidation, subordinate to goethite; observed in two of three evidence seeds.; hematite — Morteani et al. describe imperial topaz in quartz-hematite veins and use quartz-hematite-topaz intergrowths in their thermometry; the modeled phase appears in one evidence seed.
**Aspirational (0):** (none)
...
**Statistical no-shows (non-failing):** hematite
**Aspirational no-shows (non-failing):** (none)
**Excluded-locality appearances (failing):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 358.2608943547123 → 144.15206551165193 °C  [39.009873368868476, 378.5709302670796] (raw_simulation_state)
...
## Saturation drivers
  ...
  - SI_HMC: -3.654 → -2.016  [-4.913, -1.638]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 358.2608943547123 → 144.15206551165193 °C [39.009873368868476, 378.5709302670796], n=260
  - Secure aragonite assessment: 33/260 executed steps; first={"boundary_kbar":3.1906671691609483,"secure_aragonite":false}, last={"boundary_kbar":2.4487563032620914,"secure_aragonite":true}
