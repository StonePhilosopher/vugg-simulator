# CLAIM CARD — radioactive_pegmatite  (v268, seed 42, 120 steps)
...
**Archived strip SHA-256:** 5ad9b4f95aafffec9846e341ff074d497f7e0bde4f251080cc508b80ffb8cfa7
...
## Environment trajectory (first → last, [min,max])
  ...
  - O2: 0 → 0.8 mg/L  [0, 0.8] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: -3.906 → -4.283  [-4.283, -1.701]
  - SI_aragonite: -4.031 → -4.346  [-4.346, -1.827]
  - SI_dolomite: -7.685 → -8  [-8, -7.433]
  - SI_HMC: -3.78 → -2.646  [-3.843, -1.827]
  - SI_siderite: -0.693 → -1.824  [-1.824, -0.693]
  - SI_selenite: -8 → -2.016  [-8, -1.953]
  - SI_anhydrite: -8 → -3.654  [-8, -3.139]
  - SI_barite: -8 → -8  [-8, -8]
