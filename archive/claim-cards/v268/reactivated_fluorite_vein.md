# CLAIM CARD — reactivated_fluorite_vein  (v268, seed 42, 160 steps)
...
**Scenario spec hash:** 2f6aff49d783f0bc640d003278623171fb8b76dac8fd9fb9ae467c39e2559d24
**Archived strip SHA-256:** 5bd39ddb2eebd8cfc4f1011fd75a876cb9c5496c900367d72725be8a1544a76b
...
| 12 | chalcedony | 60 | 1 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 179.5362384945922 → 72.76878843065265 °C  [21, 179.5362384945922] (raw_simulation_state)
  - pH: 7.2 → 6.5200000000000005   [4.427108674862238, 7.2] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0.378 → 0  [-6.866, 0.819]
  - SI_aragonite: 0.315 → -0.126  [-6.992, 0.693]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 179.5362384945922 → 72.76878843065265 °C [21, 179.5362384945922], n=160
  - Secure aragonite assessment: 0/160 executed steps; first={"boundary_kbar":2.419589812250558,"secure_aragonite":false}, last={"boundary_kbar":2.69051001244505,"secure_aragonite":false}
