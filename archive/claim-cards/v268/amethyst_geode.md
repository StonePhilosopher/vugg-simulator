# CLAIM CARD — amethyst_geode  (v268, seed 42, 240 steps)
...
**Archived strip SHA-256:** ae98a42d0aabb965fe4fb162529b2082378e829b530b1098486486cefcf2deca
...
## Environment trajectory (first → last, [min,max])
  ...
  - O2: 0.4 → 0.4 mg/L  [0.4, 0.4] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: -1.134 → -1.26  [-1.26, -0.693]
  - SI_aragonite: -1.197 → -1.323  [-1.323, -0.819]
