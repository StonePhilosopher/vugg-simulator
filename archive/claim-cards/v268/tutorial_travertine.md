# CLAIM CARD — tutorial_travertine  (v268, seed 42, 60 steps)
...
**Archived strip SHA-256:** 89154153c7bf879af2af28260ade0ca78ad80c8d8f0a8c554494ea7754bce38a
...
## Environment trajectory (first → last, [min,max])
  ...
  - pH: 6.5 → 8.21682136813941   [6.5, 8.249717547339522] (raw_simulation_state)
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Conserved carbonate boundary: 60 samples; mode closed→closed; DIC 0.00833194467588735→0.0050772630675080515 mol/kg; export 0.011282976926660734 mol/kg; reduced alkalinity 0.0050719044424696255 eq/kg; blocked=false; failed latest transactions=0; uncertainties=["full_alkalinity_systems_omitted"]
