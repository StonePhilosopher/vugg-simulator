# CLAIM CARD — searles_lake  (v268, seed 42, 300 steps)
...
**Archived strip SHA-256:** d241e5398ca41655540f0d44ff70e7579c5870436092683a138f5acf360f3bf8
...
## Environment trajectory (first → last, [min,max])
  ...
  - O2: 1.6 → 1.8 mg/L  [1.6, 1.8] (raw_simulation_state)
  - concentration: 1 → 3 ×  [1, 3] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: 0.504 → 0.441  [0.441, 1.008]
  - SI_aragonite: 0.378 → 0.252  [0.252, 0.882]
  - SI_dolomite: 1.575 → 1.26  [1.26, 2.52]
  - SI_HMC: 0.567 → 0.378  [0.378, 1.071]
  - SI_siderite: 1.323 → 1.197  [1.197, 1.953]
  - SI_selenite: -1.638 → -1.638  [-1.638, -1.575]
  - SI_anhydrite: -1.764 → -1.764  [-1.764, -1.638]
  - SI_barite: -8 → -8  [-8, -8]
  - SI_celestine: -0.567 → -0.504  [-0.567, -0.441]
