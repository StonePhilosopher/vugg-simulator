# CLAIM CARD — sunnyside_american_tunnel  (v268, seed 42, 200 steps)
...
**Scenario spec hash:** 4badb50287f354e3ede256a34431cc16d910c76d830cd897d4f7da73fd83d4e8
**Archived strip SHA-256:** ed52133475b332e92ed38b93eeb4a36ac399572dde9fdbcea26ffef3b89ddbc6
...
## Environment trajectory (first → last, [min,max])
  ...
  - O2: 0.05 → 0.13 mg/L  [0.05, 0.13] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: -6.74 → 0.252  [-6.74, 0.252]
  - SI_aragonite: -6.866 → 0.126  [-6.866, 0.126]
  - SI_dolomite: -8 → -1.26  [-8, -1.26]
  - SI_HMC: -6.74 → 0.189  [-6.74, 0.189]
  - SI_siderite: -4.283 → 0.354  [-4.283, 0.36]
  - SI_selenite: -8 → -1.89  [-8, -1.89]
  - SI_anhydrite: -8 → -2.142  [-8, -2.142]
  - SI_barite: -8 → -8  [-8, -8]
