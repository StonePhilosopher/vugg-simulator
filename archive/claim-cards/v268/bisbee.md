# CLAIM CARD — bisbee  (v268, seed 42, 340 steps)
...
## Saturation drivers
  - SI_calcite: -6.047 → -3.648  [-7.37, -1.323]
  - SI_aragonite: -6.173 → -3.717  [-7.433, -1.449]
  - SI_dolomite: -8 → -6.929  [-8, -2.331]
  - SI_HMC: -5.858 → -2.709  [-6.425, -0.441]
  - SI_siderite: -2.457 → -0.811  [-4.409, 1.512]
