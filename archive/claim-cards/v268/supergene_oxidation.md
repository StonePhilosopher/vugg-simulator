# CLAIM CARD — supergene_oxidation  (v268, seed 42, 200 steps)
...
**Archived strip SHA-256:** 568d2763b11544a013a8adf4d05fd92c05620240322aa707c5bddb6df8779aa8
...
| 20 | covellite | 55 | 4 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 33.26089435471213 → 24.99999999999978 °C  [24.99999999999978, 48.60449873260247] (raw_simulation_state)
  - pH: 6.8 → 4.510068413339155   [4.268737900583293, 6.873928397942787] (raw_simulation_state)
...
## Saturation drivers
  ...
  - SI_siderite: 0.945 → -2.835  [-3.339, 1.323]
  - SI_selenite: -1.449 → 0.063  [-1.449, 0.063]
  - SI_anhydrite: -1.638 → -0.189  [-1.701, -0.063]
  - SI_barite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 33.26089435471213 → 24.99999999999978 °C [24.99999999999978, 48.60449873260247], n=200
  - Secure aragonite assessment: 0/200 executed steps; first={"boundary_kbar":2.9294572172274376,"secure_aragonite":false}, last={"boundary_kbar":2.988890540000002,"secure_aragonite":false}
