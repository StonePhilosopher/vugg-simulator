# CLAIM CARD — jeffrey_mine  (v268, seed 42, 200 steps)
...
**Scenario spec hash:** deeb5c4441c3fa404e696f6d1a5464d848a1231ccb33e149dbf76cff421b6749
**Archived strip SHA-256:** d1b9bbb7319c1f375fbcb1f7b779414660f9e01c586ccb45bbe54b3123d797d7
...
**Deterministic accessories (5):** dolomite — A plausible carbonate accessory in the Jeffrey rodingite-serpentinite system, subordinate to the Ca-silicate assemblage.; actinolite — A documented-style amphibole accessory at rodingite/serpentinite contacts during mafic-dike alteration.; albite — The authored late albitization stage explicitly supplies Na and licenses albite as a subordinate product.; siderite — A minor Fe-carbonate accessory permitted during late carbonate sealing.; titanite — A plausible Ca-Ti silicate accessory in metasomatized mafic dikes and rodingite contacts.
**Statistical (2):** pectolite — A documented rodingite Ca-Na silicate and authored late-stage product, but it occurs in only two of the three evidence seeds.; rhodochrosite — A minor Mn-carbonate accessory permitted after terminal carbonate enrichment; observed in two of three evidence seeds.
**Aspirational (1):** magnetite — Canonical serpentinization byproduct, but absent from the release seed audit; the redox/Fe partition needs an executed magnetite window before this becomes deterministic.
...
| 2 | calcite | 1 | 1 | 0 | nucleation |
| 3 | diopside | 1 | 4 | 0 | nucleation |
| 4 | dolomite | 1 | 1 | 0 | nucleation |
| 5 | vesuvianite | 1 | 4 | 0 | nucleation |
| 6 | actinolite | 25 | 4 | 0 | nucleation |
| 7 | brucite | 25 | 1 | 0 | nucleation |
| 8 | chrysotile | 25 | 1 | 0 | nucleation |
| 9 | grossular | 25 | 4 | 0 | nucleation |
| 10 | prehnite | 41 | 4 | 0 | nucleation |
| 11 | wollastonite | 50 | 1 | 0 | nucleation |
| 12 | albite | 140 | 2 | 0 | nucleation |
| 13 | siderite | 140 | 1 | 0 | nucleation |
| 14 | pectolite | 144 | 1 | 0 | nucleation |
| 15 | rhodochrosite | 164 | 1 | 0 | nucleation |
| 16 | datolite | 170 | 3 | 0 | nucleation |
| 17 | titanite | 170 | 1 | 0 | nucleation |
...
**Aspirational no-shows (non-failing):** magnetite
**Excluded-locality appearances (failing):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 378.2608943547102 → 328.59125707805885 °C  [224.02898204182088, 378.2608943547102] (raw_simulation_state)
  - pH: 10 → 7.795027580112222   [7.795027580112222, 10.7] (raw_simulation_state)
  ...
  - O2: 0.1 → 0.05 mg/L  [0.05, 0.1] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: 1.008 → -1.58  [-1.58, 1.449]
  - SI_aragonite: 0.882 → -1.701  [-1.701, 1.383]
  - SI_dolomite: 2.961 → -2.084  [-3.278, 4.092]
  - SI_HMC: 1.197 → -1.391  [-1.391, 1.696]
  - SI_siderite: 3.276 → 1.008  [1.008, 3.843]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -7.622 → -8  [-8, -7.622]
  - SI_barite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 378.2608943547102 → 328.59125707805885 °C [224.02898204182088, 378.2608943547102], n=200
  - Secure aragonite assessment: 0/200 executed steps; first={"boundary_kbar":3.3723416277414513,"secure_aragonite":false}, last={"boundary_kbar":2.9565247276549913,"secure_aragonite":false}
