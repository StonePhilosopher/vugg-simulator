# CLAIM CARD — asbestos_hills_crack_seal  (v268, seed 42, 110 steps)
...
**Archived strip SHA-256:** f1cb724e7de1da5189ea2bba1e6696e64c1bbce6dd88dcc9e13ab3df4bb9ed87
...
## Environment trajectory (first → last, [min,max])
  ...
  - O2: 0.28 → 0.78 mg/L  [0.28, 0.78] (raw_simulation_state)
  - concentration: 1 → 1 ×  [1, 1] (raw_simulation_state)

## Saturation drivers
  - SI_calcite: -1.328 → -2.709  [-2.709, -0.961]
  - SI_aragonite: -1.454 → -2.835  [-2.837, -1.031]
  - SI_dolomite: -1.588 → -5.165  [-5.168, -1.588]
  - SI_HMC: -1.142 → -2.769  [-2.772, -0.835]
  - SI_siderite: 3.27 → 1.01  [1.008, 3.512]
  - SI_selenite: -8 → -8  [-8, -8]
