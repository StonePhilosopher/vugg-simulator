# CLAIM CARD — porphyry  (v268, seed 42, 120 steps)
...
**Archived strip SHA-256:** 58e47ae68980c8346dfe771cb6e339461b506472385bec08477d140779e16257
...
## Saturation drivers
  - SI_calcite: -7.118 → -1.892  [-7.118, -1.764]
  - SI_aragonite: -7.181 → -2.026  [-7.181, -1.89]
  - SI_dolomite: -8 → -3.782  [-8, -3.465]
  - SI_HMC: -6.929 → -1.955  [-6.929, -1.827]
  - SI_siderite: -4.409 → 0.501  [-4.409, 0.693]
  - SI_selenite: -4.031 → -1.071  [-4.031, -1.071]
  - SI_anhydrite: -3.591 → -1.26  [-3.654, -1.26]
  - SI_barite: -8 → -8  [-8, -8]
