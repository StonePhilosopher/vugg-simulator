# CLAIM CARD — searles_lake  (v264, seed 42, 300 steps)
...
**Archived strip SHA-256:** 25b909c494ca3e9d51eb0ebbee74ac5e2e441c5d35827f7e909781fb20b29e15
...
|--|--|--|--|--|--|
| 1 | calcite | 1 | 51 | 0 | nucleation |
| 2 | celestine | 5 | 11 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 18 → 8 °C  [8, 53.71144564435855] (raw_simulation_state)
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 18 → 8 °C [8, 53.71144564435855], n=300
