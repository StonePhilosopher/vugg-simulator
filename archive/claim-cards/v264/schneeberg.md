# CLAIM CARD — schneeberg  (v264, seed 42, 160 steps)
...
**Scenario spec hash:** 63be46d25c236e6842909db92c56d42b48aa91972cb3c766c4e31792a6d33715
**Archived strip SHA-256:** fd7694209c572a1983f02b5a82f1fbf41b0d1e7800104bc03402f27fa58e460f
...
**Statistical (4):** pharmacolite — A hydrated Ca arsenate is geologically appropriate in the Schneeberg oxidation suite, but it occurs in only two of the three evidence seeds.; turquoise — A plausible minor Cu-Al phosphate in the phosphate-bearing supergene assemblage; observed in two of three evidence seeds.; realgar — The Handbook of Mineralogy records fine realgar from Schneeberg; the modeled low-temperature As-sulfide appears in two of the three evidence seeds.; pararealgar — A light-exposed vadose alteration product of realgar is possible only after the step-110 exhumation and appears in two of the three evidence seeds.
...
| 21 | brochantite | 90 | 5 | 0 | nucleation |
...
**Statistical no-shows (non-failing):** realgar, pararealgar
**Aspirational no-shows (non-failing):** haidingerite
**Excluded-locality appearances (failing):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 448.26089435470817 → 18 °C  [18, 448.26089435470817] (raw_simulation_state)
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 448.26089435470817 → 18 °C [18, 448.26089435470817], n=160
  - Secure aragonite assessment: 0/160 executed steps; first={"boundary_kbar":4.159402232773251,"secure_aragonite":false}, last={"boundary_kbar":3.04181614,"secure_aragonite":false}
