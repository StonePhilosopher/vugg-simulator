# CLAIM CARD — tutorial_first_crystal  (v251, seed 42, 30 steps)
...
## Environment trajectory (first → last, [min,max])
  - T: 218.504 → 386.811 °C  [209.646, 419.291]
...
## Saturation drivers
  ...
  - SI_dolomite: -4.094 → -5.291  [-5.291, -3.78]
  - SI_HMC: -3.654 → -4.346  [-4.346, -3.465]
