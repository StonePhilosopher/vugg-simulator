# CLAIM CARD — searles_lake  (v251, seed 42, 300 steps)
...
## Saturation drivers
  ...
  - SI_anhydrite: -1.701 → -1.701  [-2.142, -1.575]
  - SI_barite: -8 → -8  [-8, -8]
  - SI_celestine: -0.504 → -0.441  [-0.882, -0.441]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 242: mirabilite → thenardite (temperature)
