# CLAIM CARD — tutorial_travertine  (v251, seed 42, 60 steps)
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Conserved carbonate boundary: 60 samples; mode closed→closed; DIC 0.00833194467588735→0.00507730329438867 mol/kg; export 0.011282957540334433 mol/kg; reduced alkalinity 0.005071945724075801 eq/kg; blocked=false; failed latest transactions=0; uncertainties=["full_alkalinity_systems_omitted"]
