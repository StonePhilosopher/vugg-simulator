# CLAIM CARD — supergene_oxidation  (v251, seed 42, 200 steps)
...
## Saturation drivers
  - SI_calcite: -0.882 → -2.079  [-4.472, -0.252]
  - SI_aragonite: -1.008 → -2.205  [-4.598, -0.378]
  - SI_dolomite: -2.709 → -4.283  [-8, -0.756]
  - SI_HMC: -2.016 → -3.087  [-5.543, -1.318]
  - SI_siderite: 0.945 → -0.882  [-2.709, 1.386]
  - SI_selenite: -1.449 → 0.126  [-1.449, 0.126]
  - SI_anhydrite: -1.638 → -0.063  [-1.638, -0.063]
  - SI_barite: -8 → -8  [-8, -8]
