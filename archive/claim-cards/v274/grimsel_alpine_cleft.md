# CLAIM CARD — grimsel_alpine_cleft  (v274, seed 42, 200 steps)
...
**Archived strip SHA-256:** 56ec36d470fd8b154145b58343d69aeac573c3b733c6093c524e1deb08ce29e1
...
| 3 | titanite | 1 | 3 | 0 | nucleation |
| 4 | apatite | 12 | 6 | 0 | nucleation |
| 5 | quartz | 22 | 3 | 0 | nucleation |
| 6 | epidote | 54 | 5 | 0 | nucleation |
| 7 | hematite | 90 | 1 | 0 | nucleation |
| 8 | apophyllite | 157 | 1 | 0 | nucleation |
...
## Layer, solid-solution, competition, and habit testimony
  - Accepted layers: 3182; formula-bearing=0; solid-solution=0; binding competition=0; reactive transformation etches=0; masked horizons=1.
  - Masked horizon crystal 11, film step 170, breakthrough step 171: quartz through epidote; coverage term/prism=0.3/0; thickness=78.34845636964587 µm.
  ...
  - Habit crystal 9: titanite; flattened_tabular; extent=individual; forms=["tabular ∥{001}","platy sphenoid"]; size authority={"extent_kind":"individual","cap_cm":16,"record_cm":8}; CDR=null.
  - Habit crystal 10: titanite; flattened_tabular; extent=individual; forms=["tabular ∥{001}","platy sphenoid"]; size authority={"extent_kind":"individual","cap_cm":16,"record_cm":8}; CDR=null.
  - Habit crystal 11: quartz; gwindel; extent=individual; forms=["steep {40-41}/{30-31} rhombohedra dominant","subordinate m{10-10} prism","slender tapered termination"]; size authority={"extent_kind":"individual","cap_cm":1200,"record_cm":600}; CDR=null.
  ...
  - Habit crystal 13: apatite; stubby_barrel; extent=individual; forms=["short hex barrel (Cerro de Mercado / Durango)"]; size authority={"extent_kind":"individual","cap_cm":100,"record_cm":50}; CDR=null.
  - Habit crystal 14: apatite; stubby_barrel; extent=individual; forms=["short hex barrel (Cerro de Mercado / Durango)"]; size authority={"extent_kind":"individual","cap_cm":100,"record_cm":50}; CDR=null.
  - Habit crystal 15: epidote; granular; extent=individual; forms=["coarse-to-fine granular aggregate","vein-fill / saussurite replacement"]; size authority={"extent_kind":"individual","cap_cm":35,"record_cm":17.5}; CDR=null.
  - Habit crystal 16: epidote; granular; extent=individual; forms=["coarse-to-fine granular aggregate","vein-fill / saussurite replacement"]; size authority={"extent_kind":"individual","cap_cm":35,"record_cm":17.5}; CDR=null.
  - Habit crystal 17: quartz; scepter_overgrowth; extent=individual; forms=["steep {40-41}/{30-31} rhombohedra dominant","subordinate m{10-10} prism","slender tapered termination"]; size authority={"extent_kind":"individual","cap_cm":1200,"record_cm":600}; CDR=null.
  ...
  - Habit crystal 21: epidote; granular; extent=individual; forms=["coarse-to-fine granular aggregate","vein-fill / saussurite replacement"]; size authority={"extent_kind":"individual","cap_cm":35,"record_cm":17.5}; CDR=null.
  - Habit crystal 22: hematite; rhombohedral; extent=individual; forms=["{101} rhombohedron"]; size authority={"extent_kind":"individual","cap_cm":60,"record_cm":30}; CDR=null.
  - Habit crystal 23: apophyllite; druzy_crust; extent=individual; forms=["fine-grained drusy coating","sparkling colorless"]; size authority={"extent_kind":"individual","cap_cm":18,"record_cm":9}; CDR=null.
  - Habit crystal 24: fluorite; cubic; extent=individual; forms=["{100} cube"]; size authority={"extent_kind":"individual","cap_cm":400,"record_cm":200}; CDR=null.
  - Habit crystal 25: calcite; scalenohedral; extent=individual; forms=["v{211} scalenohedron","dog-tooth"]; size authority={"extent_kind":"individual","cap_cm":2000,"record_cm":1000}; CDR=null.
