# CLAIM CARD — bisbee  (v255, seed 42, 340 steps)
...
| 33 | lepidocrocite | 156 | 37 | 0 | nucleation |
| 34 | erythrite | 166 | 29 | 0 | nucleation |
| 35 | azurite | 180 | 4 | 0 | nucleation |
| 36 | annabergite | 189 | 40 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 398.2608943547122 → 25 °C  [25, 398.2608943547122] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -6.11 → -3.402  [-6.11, -1.197]
  - SI_aragonite: -6.173 → -3.465  [-6.173, -1.32]
  - SI_dolomite: -8 → -6.57  [-8, -2.205]
  - SI_HMC: -5.921 → -2.457  [-5.921, -0.315]
  - SI_siderite: -2.457 → -0.693  [-3.087, 1.512]
  - SI_selenite: -8 → -2.394  [-8, -1.134]
  - SI_anhydrite: -8 → -3.339  [-8, -2.079]
  - SI_barite: -8 → -8  [-8, -8]
