# CLAIM CARD — elmwood  (v255, seed 42, 200 steps)
...
| 9 | aragonite | 93 | 1 | 0 | nucleation |
| 10 | chalcedony | 126 | 1 | 0 | nucleation |

**Surprises (present but absent from all authored expectation tiers):** galena, pyrite, siderite, celestine, aragonite, chalcedony
...
## Environment trajectory (first → last, [min,max])
  - T: 119.99514125 → 53.26575310471222 °C  [53.26575310471222, 119.99514125] (raw_simulation_state)
