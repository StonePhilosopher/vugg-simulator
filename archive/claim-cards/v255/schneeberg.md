# CLAIM CARD — schneeberg  (v255, seed 42, 160 steps)
...
## Environment trajectory (first → last, [min,max])
  - T: 448.2608943547122 → 25 °C  [25, 448.2608943547122] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -3.906 → -3.53  [-4.535, -2.268]
  - SI_aragonite: -4.031 → -3.601  [-4.659, -2.394]
  - SI_dolomite: -7.496 → -7.688  [-8, -7.181]
  - SI_HMC: -3.78 → -2.331  [-3.843, -2.268]
  - SI_siderite: -0.882 → -1.575  [-2.142, -0.882]
  - SI_selenite: -8 → -1.89  [-8, -1.89]
  - SI_anhydrite: -8 → -3.213  [-8, -3.213]
  - SI_barite: -8 → -8  [-8, -8]
