# CLAIM CARD — searles_lake  (v255, seed 42, 300 steps)
...
**Scenario spec hash:** c5bdf3056193ed94dfe8df2b9de3eccdae69966d32e8fb348e3d5bb493e47afc
...
## Environment trajectory (first → last, [min,max])
  - T: 25 → 25 °C  [25, 53.704463973874226] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0.63 → 0.63  [0.63, 1.008]
  - SI_aragonite: 0.504 → 0.504  [0.504, 0.882]
  - SI_dolomite: 1.827 → 1.827  [1.764, 2.583]
  - SI_HMC: 0.693 → 0.693  [0.693, 1.071]
  - SI_siderite: 1.512 → 1.512  [1.512, 1.953]
  - SI_selenite: -1.638 → -1.575  [-2.016, -1.575]
  - SI_anhydrite: -1.764 → -1.701  [-2.205, -1.638]
  - SI_barite: -8 → -8  [-8, -8]
  - SI_celestine: -0.504 → -0.504  [-0.945, -0.441]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 61: mirabilite → thenardite (temperature)
  - Transformation step 61: mirabilite → thenardite (temperature)
  - Transformation step 62: borax → tincalconite (temperature)
  ...
  - Transformation step 121: borax → tincalconite (temperature)
