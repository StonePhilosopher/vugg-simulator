# CLAIM CARD — ultramafic_supergene  (v255, seed 42, 200 steps)
...
## Environment trajectory (first → last, [min,max])
  - T: 28.260894354712217 → 25 °C  [25, 28.260894354712217] (raw_simulation_state)
...
## Saturation drivers
  ...
  - SI_anhydrite: -3.402 → -3.528  [-3.843, -3.402]
  - SI_barite: -8 → -8  [-8, -8]
