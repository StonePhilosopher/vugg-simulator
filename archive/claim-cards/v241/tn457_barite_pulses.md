# CLAIM CARD — tn457_barite_pulses  (v241, seed 42, 110 steps)
...
**Scenario spec hash:** ec76315268e83dc0fb6843f5eb4af01ec5378ed6e2b67a905171feb3af7621f7

**expects_species (2):** sphalerite, barite
...
**Surprises (grown but NOT in expects_species):** pyrite, quartz, opal
**No-shows (expected but never nucleated):** (none)

## Environment trajectory (first → last, [min,max])
  - T: 118.11 → 106.299 °C  [67.913, 118.11]
  - pH: 6.504 → 6.559   [6.008, 6.669]
  - Eh: -31.496 → 77.165 mV  [-31.496, 77.165]
  - salinity: 4.724 → 4.724 psu  [4.724, 4.724]
  - O2: 0.157 → 0.394 mg/L  [0.157, 0.394]
  - concentration: 0.984 → 0.984 ×  [0.984, 0.984]

## Saturation drivers
  - SI_calcite: -2.016 → -1.827  [-2.772, -1.638]
  - SI_aragonite: -2.142 → -1.953  [-2.898, -1.764]
  - SI_dolomite: -4.22 → -4.031  [-5.795, -3.654]
  - SI_HMC: -3.654 → -3.528  [-4.409, -3.276]
  - SI_siderite: -0.252 → 0.693  [-0.378, 0.756]
  - SI_selenite: -1.26 → -1.26  [-1.26, -1.26]
  - SI_anhydrite: -1.197 → -1.26  [-1.323, -1.197]
  - SI_barite: 1.197 → 3.213  [1.197, 3.654]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 118.26089435471222 → 105.65855259178207 °C [67.84567941785791, 118.26089435471222], n=110
  - Secure aragonite assessment: 0/110 executed steps; first={"boundary_kbar":2.5081736661946623,"secure_aragonite":false}, last={"boundary_kbar":2.548737242948304,"secure_aragonite":false}
