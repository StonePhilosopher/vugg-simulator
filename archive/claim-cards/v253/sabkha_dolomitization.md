# CLAIM CARD — sabkha_dolomitization  (v253, seed 42, 260 steps)
...
| 2 | calcite | 1 | 5 | 0 | nucleation |
| 3 | dolomite | 1 | 4 | 0 | nucleation |
| 4 | HMC | 1 | 27 | 0 | nucleation |
...
## Saturation drivers
  - SI_calcite: 1.701 → 3.654  [-0.063, 3.717]
  - SI_aragonite: 1.575 → 3.465  [-0.189, 3.591]
  - SI_dolomite: 4.283 → 8  [0.693, 8]
  - SI_HMC: 0.819 → 2.772  [-0.945, 2.835]
  - SI_siderite: 2.079 → 3.843  [0.504, 3.906]
