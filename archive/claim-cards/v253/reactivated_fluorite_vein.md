# CLAIM CARD — reactivated_fluorite_vein  (v253, seed 42, 160 steps)
...
## Environment trajectory (first → last, [min,max])
  - T: 180.118 → 73.819 °C  [23.622, 180.118]
  - pH: 7.22 → 6.504   [4.465, 7.22]
  - Eh: 25.197 → 25.197 mV  [25.197, 700.787]
  - salinity: 14.961 → 14.961 psu  [3.15, 14.961]
  - O2: 0.236 → 0.236 mg/L  [0.236, 7.992]
