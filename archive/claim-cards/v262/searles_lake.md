# CLAIM CARD — searles_lake  (v262, seed 42, 300 steps)
...
**Archived strip SHA-256:** 7067fc4532e766a07a2626bbbe5ee4621c50607e3ae485f4657c46bf5c6496a6
...
|--|--|--|--|--|--|
| 1 | calcite | 1 | 53 | 0 | nucleation |
| 2 | celestine | 5 | 8 | 0 | nucleation |
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 121: mirabilite → thenardite (temperature)
  - Transformation step 180: mirabilite → thenardite (temperature)
  - Transformation step 181: borax → tincalconite (temperature)
  - Transformation step 182: mirabilite → thenardite (temperature)
