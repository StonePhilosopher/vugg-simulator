# CLAIM CARD — sulphur_bank  (v239, seed 42, 200 steps)
...
**Surprises (grown but NOT in expects_species):** metacinnabar, quartz, selenite, opal
...
## Saturation drivers
  - SI_calcite: -8 → -2.772  [-8, -2.457]
  - SI_aragonite: -8 → -2.898  [-8, -2.583]
  - SI_dolomite: -8 → -5.606  [-8, -5.102]
  - SI_HMC: -8 → -3.906  [-8, -3.843]
  - SI_siderite: -8 → -0.189  [-8, 0]
  - SI_selenite: -0.63 → -0.504  [-0.63, -0.504]
  - SI_anhydrite: -0.693 → -0.63  [-0.756, -0.567]
  - SI_barite: -8 → -8  [-8, -8]
