# CLAIM CARD — sulphur_bank  (v259, seed 42, 200 steps)
...
**Deterministic (7):** native_sulfur, cinnabar, realgar, orpiment, pararealgar, pyrite, marcasite
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
**Surprises (present but absent from all authored expectation tiers):** metacinnabar, chalcedony, opal
