# CLAIM CARD — reactivated_fluorite_vein  (v252, seed 42, 160 steps)
...
## Saturation drivers
  - SI_calcite: 0.378 → 0.126  [0.126, 0.819]
  - SI_aragonite: 0.315 → 0  [0, 0.693]
  - SI_dolomite: -0.063 → -0.756  [-1.008, 0.378]
  - SI_HMC: -1.323 → -1.197  [-1.575, -0.882]
  - SI_siderite: 1.575 → 1.953  [1.575, 2.205]
  - SI_selenite: -8 → -0.882  [-8, -0.882]
  - SI_anhydrite: -8 → -1.134  [-8, -1.008]
  - SI_barite: -8 → 1.764  [-8, 1.764]
  - SI_celestine: -8 → -0.756  [-8, -0.63]
