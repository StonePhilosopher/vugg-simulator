# CLAIM CARD — amethyst_geode  (v254, seed 42, 240 steps)
...
**Deterministic (2):** chalcedony, quartz
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
## Environment trajectory (first → last, [min,max])
  - T: 160 → 68.36745435471222 °C  [68.36745435471222, 160] (raw_simulation_state)
...
## Saturation drivers
  ...
  - SI_HMC: -2.772 → -2.331  [-2.772, -2.331]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 160 → 68.36745435471222 °C [68.36745435471222, 160], n=240
  - Secure aragonite assessment: 0/240 executed steps; first={"boundary_kbar":2.4282625400000004,"secure_aragonite":false}, last={"boundary_kbar":2.7134212897794767,"secure_aragonite":false}
