# CLAIM CARD — deccan_zeolite  (v254, seed 42, 200 steps)
...
|--|--|--|--|--|--|
| 1 | chalcedony | 20 | 4 | 0 | nucleation |
...
| 14 | aragonite | 160 | 1 | 0 | nucleation |
| 15 | goethite | 160 | 1 | 0 | nucleation |

**Surprises (present but absent from all authored expectation tiers):** albite, calcite, pectolite, feldspar, prehnite, aragonite, goethite
...
## Environment trajectory (first → last, [min,max])
  - T: 249.65217887094244 → 67.68840124993582 °C  [67.68840124993582, 249.65217887094244] (raw_simulation_state)
