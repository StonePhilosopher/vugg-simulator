# CLAIM CARD — sabkha_dolomitization  (v254, seed 42, 260 steps)
...
| 3 | dolomite | 1 | 4 | 0 | nucleation |
| 4 | HMC | 1 | 25 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  ...
  - pH: 8.870630083841732 → 9.260330483444022   [8.110043900301605, 9.292193661648] (raw_simulation_state)
...
## Saturation drivers
  ...
  - SI_HMC: 0.819 → 2.709  [-0.945, 2.772]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 240: selenite → anhydrite (gypsum-to-anhydrite-replacement)
  - Transformation step 240: selenite → anhydrite (gypsum-to-anhydrite-replacement)
  - Conserved carbonate boundary: 260 samples; mode open→open; DIC 0.004836183959203294→0.012420984025848519 mol/kg; export 0.1650718370340964 mol/kg; reduced alkalinity 0.013401525591625127 eq/kg; blocked=false; failed latest transactions=0; uncertainties=["salinity_model_missing","fluid_pressure_not_coupled_to_headspace","full_alkalinity_systems_omitted"]
