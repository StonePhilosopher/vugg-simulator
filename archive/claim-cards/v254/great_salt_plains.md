# CLAIM CARD — great_salt_plains  (v254, seed 42, 250 steps)
...
## Environment trajectory (first → last, [min,max])
  - T: 26.260894354712217 → 25 °C  [25, 31.765822053607554] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0.693 → 0.63  [-1.008, 0.819]
  - SI_aragonite: 0.504 → 0.504  [-1.134, 0.693]
  - SI_dolomite: 1.512 → 1.449  [-2.079, 1.764]
  - SI_HMC: -0.315 → -0.315  [-1.953, -0.189]
  - SI_siderite: 0.693 → 0.63  [-1.071, 0.756]
