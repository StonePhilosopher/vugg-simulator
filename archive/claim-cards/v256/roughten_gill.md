# CLAIM CARD — roughten_gill  (v256, seed 42, 200 steps)
...
**Surprises (present but absent from all authored expectation tiers):** chalcocite, orpiment, proustite, realgar, acanthite, chalcedony, pararealgar, chrysocolla, covellite, plumbogummite, vanadinite, turquoise, aurichalcite
...
## Environment trajectory (first → last, [min,max])
  - T: 128.26089435471297 → 22 °C  [22, 128.26089435471297] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -4.346 → -1.449  [-4.724, -1.386]
  - SI_aragonite: -4.409 → -1.575  [-4.85, -1.512]
  - SI_dolomite: -8 → -3.339  [-8, -3.339]
  - SI_HMC: -4.346 → -1.008  [-4.346, -1.008]
  - SI_siderite: -2.646 → -0.252  [-3.465, 0.126]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 128.26089435471297 → 22 °C [22, 128.26089435471297], n=200
  - Secure aragonite assessment: 0/200 executed steps; first={"boundary_kbar":2.4814108954849226,"secure_aragonite":false}, last={"boundary_kbar":3.0112849400000004,"secure_aragonite":false}
