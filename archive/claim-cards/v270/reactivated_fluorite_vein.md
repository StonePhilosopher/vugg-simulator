# CLAIM CARD — reactivated_fluorite_vein  (v270, seed 42, 160 steps)
...
**Scenario spec hash:** cae78a3cbf37def4f66a4a5bd25556f840b98b4b87ad1f2fe746da3e64506f86
**Archived strip SHA-256:** a98664962657463147a053d747bb596adcde886afdf9d15c994343df90a70d85
...
| 6 | galena | 20 | 2 | 0 | nucleation |
| 7 | pyrite | 20 | 2 | 0 | nucleation |
| 8 | sphalerite | 20 | 1 | 0 | nucleation |
| 9 | barite | 21 | 65 | 0 | nucleation |
| 10 | anhydrite | 22 | 6 | 0 | nucleation |
| 11 | greenockite | 22 | 5 | 0 | nucleation |
| 12 | celestine | 23 | 6 | 0 | nucleation |
| 13 | chalcedony | 60 | 1 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 179.5362384945922 → 72.76878843065285 °C  [21, 179.5362384945922] (raw_simulation_state)
  - pH: 7.2 → 6.5200000000000005   [4.4148085059448245, 7.2] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0.126 → 0  [-6.866, 0.567]
  - SI_aragonite: 0 → -0.126  [-6.992, 0.441]
  - SI_dolomite: -0.063 → -0.819  [-8, 0.378]
  - SI_HMC: 0.378 → -0.063  [-8, 0.756]
  - SI_siderite: 1.575 → -8  [-8, 2.205]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -8 → -8  [-8, 0.693]
  - SI_barite: -8 → -8  [-8, 2.205]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 179.5362384945922 → 72.76878843065285 °C [21, 179.5362384945922], n=160
  - Secure aragonite assessment: 0/160 executed steps; first={"boundary_kbar":2.419589812250558,"secure_aragonite":false}, last={"boundary_kbar":2.6905100124450487,"secure_aragonite":false}
