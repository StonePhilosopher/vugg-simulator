# CLAIM CARD — reactive_wall  (v270, seed 42, 120 steps)
...
**Scenario spec hash:** 909007beb35942a6e7bca704992c12d809b4b99f56f330f379d60c4dd7218cae
**Archived strip SHA-256:** 1d668796d713a9a11c052db7c745d5af577fdf3a860e2f5d2ae6dc2eb249943e
...
**Deterministic headline (6):** sphalerite, pyrite, dolomite, calcite, galena, marcasite
...
| 6 | calcite | 90 | 1 | 0 | nucleation |
| 7 | dolomite | 90 | 1 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 139.88405962364746 → 84.7607693410382 °C  [84.7607693410382, 139.88405962364746] (raw_simulation_state)
  - pH: 7 → 7.022816126679122   [4.198578900578383, 7.022816126679122] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0.126 → 0.693  [-4.724, 0.756]
  - SI_aragonite: 0 → 0.567  [-4.85, 0.63]
  - SI_dolomite: 0.252 → 1.071  [-8, 1.134]
  - SI_HMC: 0.315 → 0.819  [-4.535, 0.882]
  - SI_siderite: 1.197 → 2.205  [-2.898, 2.331]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -0.252 → -0.756  [-0.756, 0.063]
  - SI_barite: 1.764 → 2.079  [1.764, 2.079]
  - SI_celestine: 0.063 → -0.567  [-0.567, 0.252]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 139.88405962364746 → 84.7607693410382 °C [84.7607693410382, 139.88405962364746], n=120
  - Secure aragonite assessment: 0/120 executed steps; first={"boundary_kbar":2.4563359957489337,"secure_aragonite":false}, last={"boundary_kbar":2.632803513669159,"secure_aragonite":false}
