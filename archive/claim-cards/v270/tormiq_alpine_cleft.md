# CLAIM CARD — tormiq_alpine_cleft  (v270, seed 42, 200 steps)
...
**Archived strip SHA-256:** 97b9561098a559978d119405d372907a25dce932464a2fb765d855de69cdbed5
...
| 5 | quartz | 81 | 3 | 0 | nucleation |
| 6 | actinolite | 110 | 3 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 418.2608943547117 → 369.26494499640415 °C  [211.28775661024363, 418.2608943547117] (raw_simulation_state)
  - pH: 7 → 6.616033595503064   [6.10718248101013, 7] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -4.409 → -4.661  [-5.921, -3.843]
  - SI_aragonite: -4.346 → -4.598  [-5.858, -3.78]
  - SI_dolomite: -8 → -8  [-8, -8]
  - SI_HMC: -1.512 → -1.764  [-3.087, -1.071]
  - SI_siderite: -2.457 → -2.331  [-3.717, -1.764]
  - SI_selenite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 418.2608943547117 → 369.26494499640415 °C [211.28775661024363, 418.2608943547117], n=200
  - Secure aragonite assessment: 67/200 executed steps; first={"boundary_kbar":3.7932905449025123,"secure_aragonite":false}, last={"boundary_kbar":3.2882491111116345,"secure_aragonite":false}
