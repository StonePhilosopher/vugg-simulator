# CLAIM CARD — sabkha_dolomitization  (v270, seed 42, 260 steps)
...
**Archived strip SHA-256:** 5e12066c5107e99a1783d325218f375ed7e58ccc207e6eb8f2c076d0bcb8b414
...
| 4 | selenite | 1 | 2 | 22 | nucleation; anhydrite -> selenite |
| 5 | celestine | 5 | 3 | 0 | nucleation |
| 6 | anhydrite | 20 | 0 | 24 | selenite -> anhydrite |
...
## Environment trajectory (first → last, [min,max])
  ...
  - pH: 8.870630083841732 → 9.260330523445756   [8.110043894147463, 9.292193661648] (raw_simulation_state)
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 240: selenite → anhydrite (gypsum-to-anhydrite-replacement)
  - Conserved carbonate boundary: 260 samples; mode open→open; DIC 0.004836183959203294→0.012420985258528647 mol/kg; export 0.1650694058529475 mol/kg; reduced alkalinity 0.013401527005837206 eq/kg; blocked=false; failed latest transactions=0; uncertainties=["salinity_model_missing","fluid_pressure_not_coupled_to_headspace","full_alkalinity_systems_omitted"]
...
**Source:** archived phase-resolved sulfur ledger; exact samples are authenticated by the strip SHA-256
  ...
  - Closure: 260/260 samples; all_closed=true; max |balance error|=1.341104507446289e-7 ppm; max |testimony error|=0 ppm.
  - Fluid reservoirs (sulfide/sulfate/elemental), first → last: {"sulfide":0,"sulfate":20735999.824167453,"elemental":0} → {"sulfide":0,"sulfate":69120000,"elemental":0}.
  - Solid reservoirs, first → last: {"sulfide":0,"sulfate":0.1758325500977662,"elemental":0,"unclassified":0} → {"sulfide":0,"sulfate":6.155669704802676,"elemental":0,"unclassified":0}.
