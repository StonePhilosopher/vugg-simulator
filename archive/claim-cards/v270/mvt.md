# CLAIM CARD — mvt  (v270, seed 42, 120 steps)
...
**Scenario spec hash:** 6186d23d2fbbec9ea9503e04687e2a84f7d8e2a4fc2da4e4fe6cf7af848172e5
**Archived strip SHA-256:** 04adbd296f31cf624b2a745b55e754e46329fd49efca35c82e8a1787e107771f
...
## Environment trajectory (first → last, [min,max])
  - T: 178.260894354712 → 137.43649824522475 °C  [90.49107971857285, 178.260894354712] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: 0.126 → -0.252  [-1.509, 0.756]
  - SI_aragonite: 0 → -0.378  [-1.575, 0.693]
  - SI_dolomite: 0.252 → -0.945  [-3.15, 0.756]
  - SI_HMC: 0.441 → 0  [-1.197, 0.945]
  - SI_siderite: 1.575 → 2.016  [0.945, 2.142]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -8 → -0.126  [-8, 0.693]
  - SI_barite: -8 → 1.575  [-8, 2.142]
  - SI_celestine: -8 → 0  [-8, 1.638]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 178.260894354712 → 137.43649824522475 °C [90.49107971857285, 178.260894354712], n=120
  - Secure aragonite assessment: 0/120 executed steps; first={"boundary_kbar":2.4195970419362336,"secure_aragonite":false}, last={"boundary_kbar":2.4610771830762648,"secure_aragonite":false}
