# CLAIM CARD — sulphur_bank  (v270, seed 42, 200 steps)
...
**Scenario spec hash:** ce9ef6cb8c1df8aacd602db2595dabb7ae88100981ac1dce437d6efc19269e3b
**Archived strip SHA-256:** 554cdaf0a212a1eb304f558347232c356ecdd86a21c8f96a510e4b432b027dd2
...
**Deterministic accessories (2):** metacinnabar — Documented at Sulphur Bank as a subordinate HgS polymorph beside cinnabar.; chalcedony — Low-temperature microcrystalline silica is compatible with the hot-spring mixing zone.
**Statistical (1):** opal — The scenario models supporting hot-spring silica as opal when its low-temperature gates are met; one of the three evidence seeds realizes it.
**Aspirational (0):** (none)
...
| 6 | native_sulfur | 28 | 5 | 0 | nucleation |
| 7 | chalcedony | 32 | 4 | 0 | nucleation |
| 8 | pyrite | 32 | 1 | 0 | nucleation |
| 9 | pararealgar | 60 | 0 | 6 | realgar -> pararealgar |
| 10 | opal | 93 | 11 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  - T: 73.26089435471236 → 62.99577988162643 °C  [25.000000000000007, 77.47047671591903] (raw_simulation_state)
  - pH: 1.9000000000000001 → 6.5578610143629215   [1.7200000000000006, 6.5578610143629215] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -8 → -2.331  [-8, -2.268]
  - SI_aragonite: -8 → -2.457  [-8, -2.331]
  - SI_dolomite: -8 → -4.787  [-8, -4.661]
  - SI_HMC: -8 → -2.394  [-8, -2.268]
  - SI_siderite: -8 → 0.252  [-8, 0.252]
  - SI_selenite: -8 → -8  [-8, -7.294]
  - SI_anhydrite: -8 → -7.236  [-8, -7.189]
  - SI_barite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 73.26089435471236 → 62.99577988162643 °C [25.000000000000007, 77.47047671591903], n=200
  - Secure aragonite assessment: 0/200 executed steps; first={"boundary_kbar":2.688006134388483,"secure_aragonite":false}, last={"boundary_kbar":2.742643641422624,"secure_aragonite":false}
...
**Source:** archived phase-resolved sulfur ledger; exact samples are authenticated by the strip SHA-256
  ...
  - Closure: 200/200 samples; all_closed=true; max |balance error|=5.960464477539063e-8 ppm; max |testimony error|=2.1047890186309814e-7 ppm.
  - Fluid reservoirs (sulfide/sulfate/elemental), first → last: {"sulfide":3071998.6505027814,"sulfate":0,"elemental":0} → {"sulfide":5256131.89793438,"sulfate":2.2068245680226433,"elemental":4727308.064585995}.
  - Solid reservoirs, first → last: {"sulfide":1.34949721784011,"sulfate":0,"elemental":0,"unclassified":0} → {"sulfide":551.6220656428088,"sulfate":0,"elemental":6.208589411061211,"unclassified":0}.
