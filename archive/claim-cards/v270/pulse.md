# CLAIM CARD — pulse  (v270, seed 42, 100 steps)
...
**Scenario spec hash:** bdc8f42ca2acddb8ca4f742474431c91036bde89a67eda2f34f529e8ff3fbb08
**Archived strip SHA-256:** 4366beb3fcc89f0fd79fae8432f889d600487211015b61c0dec402e46ecd5ac5
...
## Environment trajectory (first → last, [min,max])
  - T: 348.26089435471204 → 293.41056983661764 °C  [244.65890216808998, 348.26089435471204] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -3.402 → -3.402  [-4.157, -2.961]
  - SI_aragonite: -3.465 → -3.465  [-4.22, -2.961]
  - SI_dolomite: -7.937 → -7.874  [-8, -6.929]
  - SI_HMC: -2.331 → -2.331  [-3.087, -1.89]
  - SI_siderite: -2.016 → -1.134  [-2.142, -0.882]
  - SI_selenite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 348.26089435471204 → 293.41056983661764 °C [244.65890216808998, 348.26089435471204], n=100
  - Secure aragonite assessment: 0/100 executed steps; first={"boundary_kbar":3.1070299398706833,"secure_aragonite":false}, last={"boundary_kbar":2.7336464953122794,"secure_aragonite":false}
