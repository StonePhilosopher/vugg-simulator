# CLAIM CARD — jeffrey_mine  (v270, seed 42, 200 steps)
...
**Scenario spec hash:** 6420122767381430bb01925f077bd6b031bcf6c2cfd49ff8c42094b56bc75db8
**Archived strip SHA-256:** abd5e8687c7741408d7bd013fd27fc6ee12fe5fb4aabc090a5fa28e0494223e0
...
**Aspirational (2):** dolomite — A plausible carbonate accessory in a rodingite-serpentinite system, but the corrected SIM 270 PHREEQC/SUPCRTBL trajectory remains below the commissioned heterogeneous-nucleation gate; no cited Jeffrey-specific occurrence justifies tuning the fluid to force it.; magnetite — Canonical serpentinization byproduct, but absent from the release seed audit; the redox/Fe partition needs an executed magnetite window before this becomes deterministic.
...
| 5 | brucite | 25 | 1 | 0 | nucleation |
| 6 | calcite | 25 | 1 | 0 | nucleation |
| 7 | chrysotile | 25 | 1 | 0 | nucleation |
| 8 | grossular | 25 | 4 | 0 | nucleation |
| 9 | prehnite | 41 | 4 | 0 | nucleation |
| 10 | wollastonite | 50 | 1 | 0 | nucleation |
| 11 | albite | 140 | 2 | 0 | nucleation |
| 12 | siderite | 140 | 1 | 0 | nucleation |
| 13 | pectolite | 144 | 1 | 0 | nucleation |
| 14 | rhodochrosite | 164 | 1 | 0 | nucleation |
| 15 | datolite | 170 | 3 | 0 | nucleation |
| 16 | titanite | 170 | 1 | 0 | nucleation |
...
**Aspirational no-shows (non-failing):** dolomite, magnetite
...
## Saturation drivers
  - SI_calcite: -0.189 → -2.835  [-2.835, 0.252]
  - SI_aragonite: -0.252 → -2.835  [-2.835, 0.189]
  - SI_dolomite: -0.378 → -5.42  [-5.42, 0.756]
  - SI_HMC: 1.197 → -1.386  [-1.386, 1.701]
  - SI_siderite: 1.953 → -0.318  [-0.318, 2.52]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -8 → -8  [-8, -7.622]
  - SI_barite: -8 → -8  [-8, -8]
