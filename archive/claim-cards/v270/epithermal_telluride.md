# CLAIM CARD — epithermal_telluride  (v270, seed 42, 180 steps)
...
**Scenario spec hash:** b5573190e91c4bdd641701d7e4ab9eeed7b331553537f700df5415bbd0487a80
**Archived strip SHA-256:** a7f583334eb898fea733f43d8da44c3a30bae5abd881054722424b2d4aab0ca1
...
## Environment trajectory (first → last, [min,max])
  - T: 278.2608943547121 → 266.00000000000085 °C  [125.98446567552104, 278.2608943547121] (raw_simulation_state)
  - pH: 6.5 → 6.230778537520057   [5.907487918013009, 6.691300541884266] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -3.843 → -4.472  [-5.102, -1.89]
  - SI_aragonite: -3.969 → -4.535  [-5.165, -1.953]
  - SI_dolomite: -8 → -8  [-8, -4.598]
  - SI_HMC: -3.339 → -3.969  [-4.598, -1.512]
  - SI_siderite: -1.638 → -1.071  [-1.764, 1.008]
  - SI_selenite: -8 → -8  [-8, -8]
  - SI_anhydrite: -6.173 → -6.488  [-7.559, -1.512]
  - SI_barite: -8 → -8  [-8, -8]
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Temperature: 278.2608943547121 → 266.00000000000085 °C [125.98446567552104, 278.2608943547121], n=180
  - Secure aragonite assessment: 0/180 executed steps; first={"boundary_kbar":2.655969334838852,"secure_aragonite":false}, last={"boundary_kbar":2.601169740000003,"secure_aragonite":false}
