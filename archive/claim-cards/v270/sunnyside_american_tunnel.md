# CLAIM CARD — sunnyside_american_tunnel  (v270, seed 42, 200 steps)
...
**Scenario spec hash:** fa8722103924cc26e669defeec49579e0fa054d7e9375a66eced7a7e48187b51
**Archived strip SHA-256:** f00b88cffdcfeb7c7c2136b82a9717dc6eda201c5ec35ab8d1fbbae5ab9425c3
...
**Deterministic accessories (9):** argentite — A high-temperature Ag2S precursor compatible with Sunnyside's primary polymetallic stage.; sylvanite — A legitimate Au-Ag telluride accessory in the Silverton district's early ore stage.; tennantite — A documented-style As-bearing fahlore accessory in the polymetallic sulfide assemblage.; tetrahedrite — A documented-style Sb-bearing fahlore accessory in the polymetallic sulfide assemblage.; arsenopyrite — A plausible early high-temperature As sulfide in the primary Sunnyside ore stage.; calaverite — A minor Au telluride compatible with the district's Au-Ag-Te inventory, subordinate to native gold.; proustite — A minor ruby-silver sulfosalt permitted in the Ag-bearing primary stage.; siderite — A subordinate Fe-carbonate accessory during the transition into the late Mn-carbonate stages.; native_silver — USGS Folio 120 documents wire silver in the Sunnyside Extension mine; the modeled Sunnyside system reproduces it as a subordinate Ag-bearing accessory rather than a headline phase.
**Statistical (0):** (none)
**Aspirational (0):** (none)
...
| 11 | proustite | 7 | 2 | 0 | nucleation |
| 12 | siderite | 7 | 1 | 0 | nucleation |
| 13 | native_gold | 30 | 4 | 0 | nucleation |
| 14 | rhodochrosite | 30 | 1 | 0 | nucleation |
| 15 | fluorite | 110 | 1 | 0 | nucleation |
| 16 | quartz | 110 | 3 | 0 | nucleation |
| 17 | calcite | 150 | 1 | 0 | nucleation |
| 18 | native_silver | 167 | 4 | 0 | nucleation |
...
## Environment trajectory (first → last, [min,max])
  ...
  - pH: 4.6 → 7.2   [4.6, 7.2] (raw_simulation_state)
...
## Saturation drivers
  - SI_calcite: -7.181 → 0.189  [-7.181, 0.189]
  - SI_aragonite: -7.307 → 0.126  [-7.307, 0.126]
  - SI_dolomite: -8 → -0.441  [-8, -0.441]
  - SI_HMC: -6.74 → 0.63  [-6.74, 0.63]
  - SI_siderite: -4.79 → 0.756  [-4.79, 0.756]
  - SI_selenite: -8 → -8  [-8, -8]
