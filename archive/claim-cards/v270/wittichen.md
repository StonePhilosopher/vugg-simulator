# CLAIM CARD — wittichen  (v270, seed 42, 220 steps)
...
**Scenario spec hash:** 44c1e1d548af9cf91a4aa318f7b93fd19372541b41edf615a608bc5d6066643e
**Archived strip SHA-256:** 900d4ba14d7a71d6fafe1095c849c9457d6fdcfdcf88ac457018f8905c40ad9f
...
**Deterministic headline (10):** skutterudite, nickeline, safflorite, native_bismuth, native_arsenic, native_silver, calcite, barite, erythrite, aragonite
...
**Statistical (0):** (none)
**Aspirational (3):** proustite — Ruby silver is documented in five-element vein districts, but this authored S-starved trajectory contains no independently sourced reduced-sulfur pulse sufficient to form it.; acanthite — Acanthite-coated silver is geologically possible, but oxidized meteoric sulfate cannot directly sulfidize native silver; no such conversion is claimed without an authored sulfate-reduction pathway.; realgar — Realgar is a plausible district accessory, but the valence-correct trajectory does not deliver a reduced-sulfur As-sulfide window.
...
| 10 | calcite | 170 | 1 | 0 | nucleation |
| 11 | chalcedony | 170 | 4 | 0 | nucleation |
| 12 | aragonite | 171 | 1 | 0 | nucleation |
| 13 | erythrite | 171 | 1 | 0 | nucleation |
| 14 | pharmacolite | 172 | 5 | 0 | nucleation |
| 15 | haidingerite | 201 | 0 | 3 | pharmacolite -> haidingerite |
...
**Aspirational no-shows (non-failing):** proustite, acanthite, realgar
...
## Saturation drivers
  - SI_calcite: -4.094 → 0.189  [-4.094, 0.189]
  - SI_aragonite: -4.157 → 0.063  [-4.157, 0.063]
  - SI_dolomite: -8 → -0.567  [-8, -0.567]
  - SI_HMC: -3.213 → 0.063  [-3.213, 0.693]
  - SI_siderite: -2.457 → 0.882  [-2.457, 1.008]
