# CLAIM CARD — searles_lake  (v270, seed 42, 300 steps)
...
**Archived strip SHA-256:** e1040534d76c5bd48dd1ab0e2054c370e17f77913f90939f16a18dc382ddd758
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 60: mirabilite → thenardite (temperature)
  - Transformation step 60: mirabilite → thenardite (temperature)
  - Transformation step 60: mirabilite → thenardite (temperature)
  - Transformation step 60: borax → tincalconite (temperature)
  - Transformation step 61: borax → tincalconite (temperature)
  - Transformation step 66: borax → tincalconite (temperature)
  - Transformation step 68: borax → tincalconite (temperature)
  - Transformation step 120: mirabilite → thenardite (temperature)
  - Transformation step 120: borax → tincalconite (temperature)
  - Transformation step 120: borax → tincalconite (temperature)
  - Transformation step 120: borax → tincalconite (temperature)
  - Transformation step 120: mirabilite → thenardite (temperature)
  - Transformation step 180: borax → tincalconite (temperature)
  - Transformation step 180: mirabilite → thenardite (temperature)
  - Transformation step 180: mirabilite → thenardite (temperature)
  - Transformation step 240: mirabilite → thenardite (temperature)
  - Transformation step 240: mirabilite → thenardite (temperature)
  - Transformation step 241: mirabilite → thenardite (temperature)
