# CLAIM CARD — sabkha_dolomitization  (v269, seed 42, 260 steps)
...
**Archived strip SHA-256:** 93063894ea4f1684cb52b36f106b6e7541d15703618a861f0d5f434afce50cb8
...
## Environment trajectory (first → last, [min,max])
  ...
  - pH: 8.870630083841732 → 9.260330486430671   [8.11004388258062, 9.292193661648] (raw_simulation_state)
...
**Source:** archived executed run state; not reconstructed from scenario definition
  ...
  - Transformation step 240: selenite → anhydrite (gypsum-to-anhydrite-replacement)
  - Transformation step 240: selenite → anhydrite (gypsum-to-anhydrite-replacement)
  - Conserved carbonate boundary: 260 samples; mode open→open; DIC 0.004836183959203294→0.012420984117882661 mol/kg; export 0.16507183808973952 mol/kg; reduced alkalinity 0.013401525697212808 eq/kg; blocked=false; failed latest transactions=0; uncertainties=["salinity_model_missing","fluid_pressure_not_coupled_to_headspace","full_alkalinity_systems_omitted"]
...
**Source:** archived phase-resolved sulfur ledger; exact samples are authenticated by the strip SHA-256
  ...
  - Closure: 260/260 samples; all_closed=true; max |balance error|=0.0000028461217880249023 ppm; max |testimony error|=0 ppm.
  - Fluid reservoirs (sulfide/sulfate/elemental), first → last: {"sulfide":0,"sulfate":20735999.824715935,"elemental":0} → {"sulfide":0,"sulfate":69119975.12744519,"elemental":0}.
  - Solid reservoirs, first → last: {"sulfide":0,"sulfate":0.17528406314204403,"elemental":0,"unclassified":0} → {"sulfide":0,"sulfate":304.5390163806128,"elemental":0,"unclassified":0}.
