...
const MODEL_DIGEST = [
  ...
  'collection-product:exact-player-owned-name+shared-text-only-library-and-record-groove-rendering-v1',
  'strip-storage:production-vs-import-origin+content-addressed-import-key+full-payload-readback-digest+per-origin-five-cache+atomic-eviction-and-insertion-v1',
].join('|');
