...
const MODEL_DIGEST = [
  ...
  'evidence-binding:exact-browser-dist-runtime-data+producer-contracts+timestamp-free-strips+mechanism-witness-artifact+player-choice-divergence+guided-tutorial-lifecycle+full-public-control-browser-journey+full-stored-strip-byte-receipt+aggregate-artifact-sha256-v7',
