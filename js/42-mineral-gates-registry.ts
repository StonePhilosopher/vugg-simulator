...
const MINERAL_GATES_REGISTRY: Record<string, MineralGates> = {
  ...
  haidingerite: MINERAL_GATES_haidingerite,
  ...
  'meta-autunite': MINERAL_GATES_meta_autunite,
  metatorbernite: MINERAL_GATES_metatorbernite,
  metazeunerite: MINERAL_GATES_metazeunerite,
  ...
  titanite: MINERAL_GATES_titanite,
  ...
  chabazite: MINERAL_GATES_chabazite,
