...
const MINERAL_SPEC_FALLBACK = {
  ...
  malachite: { formula: "Cu2(CO3)(OH)2", nucleation_sigma: 1.0, max_size_cm: 18, size_authority: { individual_record_cm: 9, individual_cap_cm: 18, aggregate_record_cm: 9, aggregate_cap_cm: null, aggregate_habits: ["botryoidal", "banded_massive", "acicular_spray", "pseudomorph_after_azurite", "stalactitic"] }, growth_rate_mult: 0.8, thermal_decomp_C: 200, fluorescence: null, twin_laws: [], acid_dissolution: { pH_threshold: 4.5 } },
...
function crystalSizeAuthority(crystal) {
  ...
  return Object.freeze({
    ...
    sources: Object.freeze(Array.isArray(authority.sources) ? [...authority.sources] : []),
  });
}
