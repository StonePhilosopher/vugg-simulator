...
>
> ## ⬡ ARC (2026-06-22) — DIRECTIONAL / POLAR / STEPPED GROWTH (the central-distance model) — RESEARCHED · PHASE 0+1+2+3 SHIPPED · PHASE 4 DESIGN + 4a.0 KERNEL + 4a.1 FLUORITE TENANT + 4a.2 HEX-R (CALCITE) KERNEL SHIPPED (byte-identical, render-only)
>
