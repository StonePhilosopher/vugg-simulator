...
| **mvt** (Tri-State) | smooth-spar 98%, **scalenohedral** (CORRECTED 2026-06-12 — the verification pass's FIRST CATCH: boss observed rhombs where Joplin grows golden dogtooth; broth Mg 30→65, the dolomitizing-brine value the v187 calibration undershot; live Mg:Ca 0.163) | no (2% core sliver, below floor) | Joplin/Picher: glassy smooth-faced DOGTOOTH — scalenohedral, no terracing | form is broth-driven here: live Mg:Ca must clear `MG_SCALENO` 0.15 AFTER the fluid-mixing event raises Ca to 400 (the first fix at Mg 50 failed exactly this way) |
