...
/** Canonical authored-text projection shared by builders and receipt hashing. */
export function normalizeTextLf(text) {
...
export function bytesForHash(file, policy = CURRENT_HASH_POLICY) {
  ...
  return text.includes(CR) ? Buffer.from(normalizeTextLf(text), 'utf8') : raw;
}
